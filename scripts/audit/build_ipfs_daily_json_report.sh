...
jq -cn \
  ...
  '{
    ...
    rule:"JSON files are inventoried daily, hashed by raw file bytes, and pinned when IPFS CLI is available. Authority is _truth/audit; distribution is docs/audit."
  }' > "$MAN"
